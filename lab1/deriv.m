function V = deriv(U,Ts)

% U is the discrete-time input matrix
% Ts is the sampling time


% Computes 5-point discrete derivative estimates for each column of the input matrix U
% V = time_deriv(U,Ts) Returns a matrix V of the same size as U each
% element containing the estimates of the column-wise derivative of
% a function sampled at unit intervals Ts
%
% time_deriv uses 5 points both in the interior and at the edges
% If size of the matrix U is less than 5 use simpler 3-point or 2-point estimate
%
